...
some other ruleset that depends on rules_gn, or in a nested
...
```sh
OVERRIDE="--override_repository=rules_gn=$(pwd)/rules_gn"
echo "common $OVERRIDE" >> ~/.bazelrc
```

This means that any usage of `@rules_gn` on your system will point to this folder.
...
https://github.com/matts1/rules_gn/actions/workflows/tag.yaml
