...
# By default all these toolchains are registered by the gn_register_toolchains macro
...
toolchain(
    ...
    toolchain = "@{user_repository_name}_{platform}//:gn_toolchain",
    toolchain_type = "@rules_gn//gn:toolchain_type",
)
""".format(
            platform = platform,
